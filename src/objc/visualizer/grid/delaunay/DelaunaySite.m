...
- (NSString *) description {
   return [NSString stringWithFormat: @"S%ld (%f, %f)", index, coordinates.x, coordinates.y];
}
...
- (NSMutableArray *) region {
   region; // TODO: removes compile error
   ...
   for (DelaunayEdge *edge in self.edges) {
      ...
      [unfilteredVertices addObject: [NSValue valueWithCGPoint:edge.leftVertex.coordinates]];
      [unfilteredVertices addObject: [NSValue valueWithCGPoint:edge.rightVertex.coordinates]];
   ...
   for (int i=1; i< [unfilteredVertices count]; i++) {
      ...
      if (DISTANCE(p1,p2) > EPSILON) {
         [filteredVertices addObject:[NSValue valueWithCGPoint:p2]];
      }
   }
...
- (NSMutableArray *) clipToBounds: (CGRect) bounds {
   ...
   [points addObject:[NSValue valueWithCGPoint:[edge clippedPoint: orientation]]];
   [points addObject:[NSValue valueWithCGPoint:[edge clippedPoint: [orientation opposite]]]];
...
- (void) connect: (NSMutableArray *) points atIndex: (NSInteger) j bounds: (CGRect) bounds closingUp: (BOOL) closingUp {
      ...
      if (rightPoint.x != newPoint.x && rightPoint.y != newPoint.y)
      {
         ...
         if (rightCheck & BoundsMaskRight) {
            ...
            if (newCheck & BoundsMaskBottom) {
               ...
               [points addObject: [NSValue valueWithCGPoint:CGPointMake(px, py)]];
               ...
               [points addObject: [NSValue valueWithCGPoint:CGPointMake(px, py)]];
               [points addObject: [NSValue valueWithCGPoint:CGPointMake(bounds.origin.x, py)]];
            }
            ...
            if (newCheck & BoundsMaskBottom)
            {
               ...
               [points addObject: [NSValue valueWithCGPoint:CGPointMake(px, py)]];
               [points addObject: [NSValue valueWithCGPoint:CGPointMake(bounds.origin.x + bounds.size.width, py)]];
            }
            ...
            if (newCheck & BoundsMaskRight) {
               ...
               [points addObject: [NSValue valueWithCGPoint:CGPointMake(px, py)]];
               [points addObject: [NSValue valueWithCGPoint:CGPointMake(px, bounds.origin.y + bounds.size.height)]];
            }
            ...
            if (newCheck & BoundsMaskRight) {
               ...
               [points addObject: [NSValue valueWithCGPoint:CGPointMake(px, py)]];
               [points addObject: [NSValue valueWithCGPoint:CGPointMake(px, bounds.origin.y)]];
            }
         }
      }
      if (closingUp)
   ...
   {
      [points addObject: [NSValue valueWithCGPoint:newRightPoint]];
   }
}
