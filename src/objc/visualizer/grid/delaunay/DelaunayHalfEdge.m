...
+ (DelaunayHalfEdge *) halfEdgeWithEdge: (DelaunayEdge *)edge orientation: (DelaunayOrientation *) orientation {
   DelaunayHalfEdge *result = [[DelaunayHalfEdge alloc] init];
   result.edge = edge;
...
- (NSString *) description {
   return [NSString stringWithFormat: @"HalfEdge (id: %p vertex: %ld edge: %ld - %ld orientation: %@ leftNeighbor: %p rightNeighbor: %p nextInPriorityQueue: %p ystar: %f", 
