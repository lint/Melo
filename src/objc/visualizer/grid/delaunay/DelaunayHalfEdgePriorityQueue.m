...
- (NSString *) description {
   return [NSString stringWithFormat: @"HalfEdgePriorityQueue (minY: %f deltaY: %f hashSize: %ld count: %ld minBucket: %ld hash: %@", minY, deltaY, hashSize, count, minBucket, hash];
}
